...
[![Run on Repl.it](https://repl.it/badge/github/danielpetersson/snake.git)](https://repl.it/github/danielpetersson/snake.git)

1. Login to your [Repl.it](https://repl.it) account.

2. Click the 'Run on Repl.it' button above, or visit the following URL: https://repl.it/github/danielpetersson/snake.git.
